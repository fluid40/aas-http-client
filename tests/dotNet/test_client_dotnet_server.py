...
def test_005a_put_shells(client: AasHttpClient, shared_aas: model.AssetAdministrationShell):
...
def test_005b_put_shells_with_id(client: AasHttpClient, shared_aas: model.AssetAdministrationShell):
    # put with other ID
...
def test_009_post_submodels(client: AasHttpClient, shared_sm: model.Submodel):
...
def test_013_put_shells_submodels_by_id(client: AasHttpClient, shared_aas: model.AssetAdministrationShell, shared_sm: model.Submodel):
    sm = model.Submodel(shared_sm.id_short)
    sm.id_short = shared_sm.id_short
...
def test_016_post_submodels_submodel_elements(client: AasHttpClient, shared_sm: model.Submodel, shared_sme: model.Property):
